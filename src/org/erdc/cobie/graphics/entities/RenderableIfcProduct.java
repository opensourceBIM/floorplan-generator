...
import org.erdc.cobie.graphics.Parser;
...
import org.erdc.cobie.graphics.Selector;
...
import org.erdc.cobie.graphics2d.RenderData2D;
import org.erdc.cobie.graphics2d.Stroke;
import org.erdc.cobie.graphics3d.RenderData3D;
...
public abstract class RenderableIfcProduct implements EngineUser, Selector<RenderData2D, RenderData3D>
{
    ...
    {        
		parser.parse();
    	GeometryInfo mesh = org.erdc.cobie.graphics3d.Utils.makeMesh(parser.getVertices(), parser.getNormals());   	
