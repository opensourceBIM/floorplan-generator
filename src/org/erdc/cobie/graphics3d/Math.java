...
public class Math
{
    ...
    public static Point3d getCenter(GeometryInfo mesh, Orientation orientation)
    {
        ...
        double xMean = org.erdc.cobie.graphics.Math.getMean(xCoordinates);
        double yMean = org.erdc.cobie.graphics.Math.getMean(yCoordinates);
        double zMean = org.erdc.cobie.graphics.Math.getMean(zCoordinates);
