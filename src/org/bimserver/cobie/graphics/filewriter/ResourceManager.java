...
public class ResourceManager
{
    ...
    private final Map<String, List<String>> jarDirectoryContents = new HashMap<String, List<String>>();
    
    public ResourceManager(List<URI> resources, URI destination, PluginManager pluginManager, Plugin plugin)
    {
        this.resources = resources;
        this.rootDestination = destination;
        this.plugin = plugin;
        this.pluginManager = pluginManager;
        this.context = pluginManager.getPluginContext(plugin);
    }
